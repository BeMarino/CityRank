...
def merge():
    #Lettura dei dataset
    reddito = pd.read_csv("Progetto-Open-Data/dataset/Reddito medio complessivo per contribuente.csv")
    retribuzione = pd.read_csv("Progetto-Open-Data/dataset/Retribuzione media.csv")
    pensioni = pd.read_csv("Progetto-Open-Data/dataset/Importo medio delle pensioni di vecchiaia.csv")
    rifiuti = pd.read_csv("Progetto-Open-Data/dataset/Raccolta Differenziata_Produzione Rifiuti.csv")
    incidenti = pd.read_csv("Progetto-Open-Data/dataset/Incidenti Stradali.csv")
    furti_auto = pd.read_csv("Progetto-Open-Data/dataset/Furti di autovetture.csv")
    furti_casa = pd.read_csv("Progetto-Open-Data/dataset/Furti in abitazione.csv")
    tasso_disoccupazione = pd.read_csv("Progetto-Open-Data/dataset/Tasso di disoccupazione.csv")
    tasso_disoccupazione_g = pd.read_csv("Progetto-Open-Data/dataset/Tasso di disoccupazione giovanile.csv")
    diff_tasso = pd.read_csv("Progetto-Open-Data/dataset/Differenza fra tasso di occupazione maschile e femminile.csv")
    tasso_natalita = pd.read_csv("Progetto-Open-Data/dataset/Tasso di natalità.csv")
    tasso_mortalita = pd.read_csv("Progetto-Open-Data/dataset/Tasso di mortalità.csv")
    indice_v = pd.read_csv("Progetto-Open-Data/dataset/Indice di vecchiaia.csv")
    posti = pd.read_csv("Progetto-Open-Data/dataset/Densita di posti letto nelle strutture ricettive.csv")
    banda = pd.read_csv("Progetto-Open-Data/dataset/Penetrazione della banda ultra larga.csv")
    popolazione = pd.read_csv("Progetto-Open-Data/dataset/Censimento cittadini province.csv")
    superficie = pd.read_csv("Progetto-Open-Data/dataset/Superficie province.csv")

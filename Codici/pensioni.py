...
def get_data():
    ...
    f = open("Open Data/dataset/Palermo/Palermo_inps.csv","r") 
    f1 = open("Open Data/dataset/Napoli/Napoli_inps.csv","r")
    f2 = open("Open Data/dataset/Roma/Roma_inps.csv","r")
    f3 = open("Open Data/dataset/Milano/Torino_milano_inps.csv","r")
    reader = csv.reader(f)

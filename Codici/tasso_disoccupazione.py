...
def get_data():
    f = open("Tasso di disoccupazione.csv","wt")        #Creiamo il file che conterrà il tasso di disoccupazione totale
    writer = csv.writer(f)
    writer.writerow(["Provincia","Tasso di disoccupazione"])             #Scriviamo l'intestazione
    
    f1 = open("Tasso di disoccupazione giovanile.csv","wt")   #Creiamo il file che conterrà il tasso di disoccupazione giovanile  
    writer1 = csv.writer(f1)
    writer1.writerow(["Provincia","Tasso di disoccupazione giovanile"])#Scriviamo l'intestazione
    
    with open("Open Data/dataset/Tasso di disoccupazione.csv") as fi:
